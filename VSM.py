...
def render_vsm():
    ...
    def selected_documents(select_documents, text_area, use_stopword, stop_language, stem_or_lem):
        ...
        if select_documents == "File":
            ...
            if text_area:
                ...
                text_documents = [preprocess(text, use_stopword, stop_language, stem_or_lem) for text in text_area]
